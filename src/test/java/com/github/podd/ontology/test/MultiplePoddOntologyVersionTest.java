        ...
        final Object[][] data =
                new Object[][] {
                        ...
                        { MultiplePoddOntologyVersionTest.VERSION_1_PATH + "poddScience.owl", "application/rdf+xml",
                                1447 },
                        { MultiplePoddOntologyVersionTest.VERSION_1_PATH + "poddPlant.owl", "application/rdf+xml", 214 },
                        ...
                        { MultiplePoddOntologyVersionTest.VERSION_2_PATH + "poddScience.owl", "application/rdf+xml",
                                1447 },
                        { MultiplePoddOntologyVersionTest.VERSION_2_PATH + "poddPlant.owl", "application/rdf+xml", 214 },
