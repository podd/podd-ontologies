    ...
    public static Collection<Object[]> data()
    {
        final Object[][] data =
                new Object[][] {
                        ...
                        { PoddOntologyVersion2Test.VERSION_2_PATH + "poddScience.owl", "application/rdf+xml", 1447 },
                        { PoddOntologyVersion2Test.VERSION_2_PATH + "poddPlant.owl", "application/rdf+xml", 214 },
